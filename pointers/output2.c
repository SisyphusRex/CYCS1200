...
int main(void)
{
    ...
    IntNode_Create(node1, 5, NULL);
    IntNode_InsertAfter(headObj, node1);

    node2 = (IntNode *)malloc(sizeof(IntNode));
    IntNode_Create(node2, 42, NULL);
    IntNode_InsertAfter(node1, node2);

    node3 = (IntNode *)malloc(sizeof(IntNode));
    IntNode_Create(node3, 33, NULL);
    IntNode_InsertAfter(node2, node3);

    node4 = (IntNode *)malloc(sizeof(IntNode));
    IntNode_Create(node4, 19, NULL);
